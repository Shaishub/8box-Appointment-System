 ...
 <div class="container">
     ...
     <table class="menu-container" border="0">
             ...
             <tr class="menu-row" >
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-sessions menu-active menu-icon-sessions-active">
                        <a href="schedule.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Set Appointment</p></div></a>
                    </td>
                </tr>
                <tr class="menu-row" >
        ...
        <?php
                ...
                $sqlmain= "select * from schedule inner join employee on schedule.eid=employee.eid where schedule.scheduledate>='$today'  order by schedule.scheduledate asc";
                $sqlpt1="";
                $insertkey="";
                $q='';
                $searchtype="All";
                        ...
                        if(!empty($_POST["search"])){
                            ...
                            $sqlmain= "select * from schedule inner join employee on schedule.eid=employee.eid where schedule.scheduledate>='$today' and (employee.ename='$keyword' or employee.ename like '$keyword%' or employee.ename like '%$keyword' or employee.ename like '%$keyword%' or schedule.title='$keyword' or schedule.title like '$keyword%' or schedule.title like '%$keyword' or schedule.title like '%$keyword%' or schedule.scheduledate like '$keyword%' or schedule.scheduledate like '%$keyword' or schedule.scheduledate like '%$keyword%' or schedule.scheduledate='$keyword' )  order by schedule.scheduledate asc";
                            //echo $sqlmain;
                            $insertkey=$keyword;
                ...
                <tr >
                    ...
                    <td >
                            <form action="" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Personnel name or Email or Date (YYYY-MM-DD)" list="employee" value="<?php  echo $insertkey ?>">&nbsp;&nbsp;
                                        
                                        <?php
                                            echo '<datalist id="employee">';
                                            $list11 = $database->query("select DISTINCT * from  employee;");
