                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                <td width="40%" style="padding-left:20px" >
                                    <img src="../img/profile_pic/<?php echo $userfetch["profile_pic"]?>" alt="" width="100%" style="border-radius:50%">
                                </td>
                    ...
                    if($_POST){
                        ...
                        if(isset($_POST["filter"])){
                            if($_POST["showonly"]=='all'){
                                ...
                                $sqlmain= "select * from appointment inner join client on client.pid=appointment.pid inner join schedule on schedule.scheduleid=appointment.scheduleid where schedule.eid=$userid;";
                                $selecttype="My";
                                $current="My clients Only";
                            }
                        }
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <?php
                               ...
                               //$list12= $database->query("select * from appointment inner join patient on patient.pid=appointment.pid inner join schedule on schedule.scheduleid=appointment.scheduleid where schedule.eid=1;");
