...
<body>
    ...
    $sqlmain= "select appointment.appoid,schedule.scheduleid,schedule.title,schedule.schedule_meeting,schedule.schedule_type,schedule.schedule_set,employee.ename,client.cname,schedule.scheduledate,schedule.scheduletime,appointment.apponum,appointment.appodate from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join client on client.cid=appointment.pid inner join employee on schedule.eid=employee.eid  where  client.cid=$userid ";
        ...
        <table class="menu-container" border="0">
                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                <td width="40%" style="padding-left:20px" >
                                    <img src="../img/profile_pic/<?php echo $userfetch["cprofile_pic"]?>" alt="<?php echo $userfetch["cprofile_pic"]?>" width="100%" style="border-radius:50%">
                                </td>
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-appoinment  menu-active menu-icon-appoinment-active">
                        <a href="appointment.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Booked Appointments</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                                ...
                                if($result->num_rows==0){
                                    ...
                                    for ( $x=0; $x<($result->num_rows);$x++){
                                        ...
                                        for($q=0;$q<3;$q++){
                                            ...
                                            $appoid=$row["appoid"];
                                            $schedule_meeting=$row["schedule_meeting"];
                                            $schedule_type=$row["schedule_type"];
                                            $schedule_set=$row["schedule_set"];
                                                    ...
                                                    <div  class="dashboard-items search-items"  >
                                                        ...
                                                        <div class="h3-search">
                                                                ...
                                                                <div class="h4-search">
                                                                    ...
                                                                    Appoitnment type: '.$schedule_type.' <br>
                                                                    Meeting set: '.$schedule_set.' <br>
                                                                    Meeting: <a href="'.$schedule_meeting.'">'.$schedule_meeting.'</a>

                                                                </div>
                                                                
                                                                <br>
                                                                <a href="?action=drop&id='.$appoid.'&title='.$title.'&emp='.$ename.'" ><button  class="login-btn btn-primary-soft btn "  style="padding-top:11px;padding-bottom:11px;width:100%"><font class="tn-in-text">Cancel Booking</font></button></a>
                                                        </div>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                            ...
                            Personnel name&nbsp; : <b>'.substr($ename,0,40).'</b><br><br>
