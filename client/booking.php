                     ...
                     <table border="0" class="profile-container">
                         <tr>
                             <td width="40%" style="padding-left:20px" >
                                 <img src="../img/profile_pic/<?php echo $userfetch["profile_pic"]?>" alt="">
                             </td>
             ...
             <tr class="menu-row" >
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-employee">
                        <a href="employee.php" class="non-style-link-menu"><div><p class="menu-text">All Personell</p></a></div>
                    </td>
                </tr>
                ...
                <tr >
                    ...
                    <td >
                            <form action="schedule.php" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Personnel name or Email or Date (YYYY-MM-DD)" list="employee" >&nbsp;&nbsp;
                        ...
                        <tbody>
                            ...
                            if(($_GET)){
                                ...
                                if(isset($_GET["id"])){
                                    ...
                                    $sqlmain= "select * from schedule inner join employee on schedule.eid=employee.eid where schedule.scheduleid=$id  order by schedule.scheduledate desc";
                                            ...
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;line-height:30px">
                                                            Personnel name:  &nbsp;&nbsp;<b>'.$ename.'</b><br>
                                                            Personnel Email:  &nbsp;&nbsp;<b>'.$eemail.'</b> 
                                                        </div>
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;">
                                                            ...
                                                            Appointment Starts : '.$scheduletime.'<br>
                                                            Appointment type: '.$schedule_type.' <br>
                                                            Appointment set: '.$schedule_set.' <br>
