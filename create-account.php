        ...
        if($result->num_rows==1){
            ...
            if (is_uploaded_file($_FILES['profile-pic']['tmp_name'])) {
                ...
                if (move_uploaded_file($_FILES['profile-pic']['tmp_name'], $profile_pic_folder)) {
                    ...
                    $database->query("insert into client(cemail,cname,cpassword,cdoc,ccontact,caddress,ctype,cstatus,ccompany_name,ccompany_position,profile_pic) values('$email','$name','$newpassword','$doc','$contact','$address','$company_type','$client_status','$company_name','$company_position','$profile_pic')");
