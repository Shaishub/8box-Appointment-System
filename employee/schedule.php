 ...
 <div class="container">
    ...
    if($_GET){
        ...
        if($action=='add-session'){
                                ...
                                <td class="label-td" colspan="2">
                                    ...
                                    <option value="" disabled selected hidden>Choose Personnel Name from the list</option><br/>';
                                        ...
                                        for ($y=0;$y<$list11->num_rows;$y++){
                                            ...
                                            echo "<option value=".$eid.">$ename</option><br/>";
                                        };
            ...
            $sqlmain12= "select * from appointment inner join client on client.cid=appointment.pid inner join schedule on schedule.scheduleid=appointment.scheduleid where schedule.scheduleid=$id;";
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-employee-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Email" class="form-label">Personnel of this session: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="number" class="form-label">Scheduled Date: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="ccontact" class="form-label">Scheduled Time: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
