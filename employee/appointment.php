            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td width="15%">
                        ...
                        $list110 = $database->query("select * from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join client on client.cid=appointment.pid inner join employee on schedule.eid=employee.eid  where  employee.eid=$eid ");
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="eid" class="form-label">Select Personnel: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
